...
if (window.location.href.indexOf("/success/") > -1) {
  ...
  addCss('https://api.coclima.com/cssNS');
  ...
  function addPopUp() {
    ...
    var treesDesc2 = document.createElement('span');
    ...
    treesDesc.appendChild(document.createTextNode(`Esta loja já contribuiu com o plantio de`));
    /*   treesValue.appendChild(document.createTextNode('1000')); */
    treesDesc2.appendChild(document.createTextNode(` várias árvores!`));
